...
<?
    ...
    if($id == null) {
     ...
     if($id == "admin") {
        header("Location: license_admin.php"); exit;
     }
...
<script type="text/javascript">
	function loginCheck() {
		...
		if(document.getElementById("id").value == "") {
			...
			xmlhttpPostXML('login_excute.php?id=' + document.getElementById("id").value + '&password=' + Base64.encode(document.getElementById("password").value), null, 'loginExcute','3');
		}
	}
	...
	function loginExcute(xml) {
		...
		if(result == "1") {
			...
			self.location.href = "license_admin.php";
		}
	}
</script>
</head>
