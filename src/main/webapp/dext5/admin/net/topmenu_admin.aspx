<%	/**
 	* @File		:	topmenu_admin.aspx
 	* @Function	:	관리자 시스템 상단메뉴 관리 페이지
...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="topmenu_admin.aspx.cs" Inherits="dext5_admin_NET_Default" %>
		...
		<div class="header">
			...
			<div class="top_menu">
				<ul>
					...
					<li><a href="topmenu_admin.aspx" class="on">상단메뉴 관리</a></li>
