<%	/**
 	* @File		:	uploader_setting.aspx
 	* @Function	:	관리자 시스템 업로드 환경설정 페이지
...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="uploader_setting.aspx.cs" Inherits="dext5_admin_NET_Default" %>
		...
		<div class="header">
			...
			<div class="top_menu">
				<ul>
					...
					<li><a href="uploader_setting.aspx" class="on">업로드 환경설정</a></li>
				</ul>
			</div>
		</div>
		<div class="content">
