...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="license_admin.aspx.cs" Inherits="dext5_admin_NET_Default" %>
...
<body class="dext5_editor" onload="xmlhttpPostXML('../../config/dext_editor.xml', null, 'xmlAdmin','1');">
	<div class="container">
		<div class="header">
			...
			<div class="top_menu">
				<ul>
					<li><a href="license_admin.aspx" class="on" style="margin-left: 0;">라이선스 관리</a></li>
			...
			<div class="htb">
				<table cellpadding="0" cellspacing="0" border="0" summary="라이선스 관리">
					<tr>
						...
						<td width="78%">
							<input id="product_key_1" name="product_key_1" type="text" maxlength=4 onkeyup="javascript:next(this);" class="in"/> -
							<input id="product_key_2" name="product_key_2" type="text" maxlength=4 onkeyup="javascript:next(this);" class="in"/> -
							<input id="product_key_3" name="product_key_3" type="text" maxlength=4 onkeyup="javascript:next(this);" class="in"/> -
							<input id="product_key_4" name="product_key_4" type="text" maxlength=4 class="in"/>
						</td>
					</tr>
					<tr>
