...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fontsize_admin.aspx.cs" Inherits="dext5_admin_NET_Default" %>
		...
		<div class="header">
			...
			<div class="top_menu">
				<ul>
					...
					<li><a href="fontsize_admin.aspx" class="on">폰트크기 관리</a></li>
