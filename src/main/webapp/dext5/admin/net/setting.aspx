...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="setting.aspx.cs" Inherits="dext5_admin_NET_Default" %>
		...
		<div class="header">
			...
			<div class="top_menu">
				<ul>
					...
					<li><a href="setting.aspx" class="on">환경설정</a></li>
			...
			<div class="htb">
				<table cellpadding="0" cellspacing="0" border="0" summary="기본설정">
					...
					<tr>
                        ...
                        <td width="30%"><select name="lang" id="lang" runat="server"></select></td>
					</tr>
					<tr>
