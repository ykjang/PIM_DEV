...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="removeitem_admin.aspx.cs" Inherits="dext5_admin_NET_Default" %>
		...
		<div class="header">
			...
			<div class="top_menu">
				<ul>
					...
					<li><a href="removeitem_admin.aspx" class="on">제거항목 관리</a></li>
