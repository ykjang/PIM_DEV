...
<script type="text/javascript">
	self.location.href = "license_admin.jsp";
</script>
<% } else { %>
...
<script type="text/javascript">
	function loginCheck() {
		...
		if(document.getElementById("id").value == "") {
			...
			xmlhttpPostXML('login_excute.jsp?id=' + document.getElementById("id").value + '&password=' + Base64.encode(document.getElementById("password").value), null, 'loginExcute','3');
		}
