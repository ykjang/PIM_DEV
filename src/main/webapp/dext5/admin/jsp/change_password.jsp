<%	/**
 	* @File		:	change_password.jsp
 	* @Function	:	관리자 시스템 비밀번호 변경 페이지
...
<script type="text/javascript">
    function loginCheck() {
        if (document.getElementById("password").value == "") {
            ...
            xmlhttpPostXML('change_excute.jsp?password=' + Base64.encode(document.getElementById("password").value) + '&new_pw=' + Base64.encode(document.getElementById("new_pw").value), null, 'changeExcute');
        }
    }
